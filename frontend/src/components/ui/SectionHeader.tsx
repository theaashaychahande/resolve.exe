...
export default function SectionHeader({ tag, title, description, dark = false }: SectionHeaderProps) {
  return (
    <div className="text-center mb-16 lg:mb-20">
      ...
      <p className={`max-w-2xl mx-auto text-lg leading-relaxed ${dark ? 'text-white/70' : 'text-gray-600'}`}>
        {description}
      </p>
    </div>
  );
